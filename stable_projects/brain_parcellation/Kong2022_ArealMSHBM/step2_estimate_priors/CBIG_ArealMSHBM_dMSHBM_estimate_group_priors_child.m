function CBIG_ArealMSHBM_dMSHBM_estimate_group_priors_child(s, mesh, tmp_dir)

% CBIG_ArealMSHBM_dMSHBM_estimate_group_priors_child(s, mesh, tmp_dir)
%
% This is the child script to estimate group priors for the distributed individual
...
% num_sub child jobs.
% Check CBIG_ArealMSHBM_dMSHBM_estimate_group_priors_parent.m for more details.
%
% Input:
%
%   - s: (string)
...
%
% Example:
%   CBIG_ArealMSHBM_dMSHBM_estimate_group_priors_child('1', 'fs_LR_32k', tmp_dir)
%

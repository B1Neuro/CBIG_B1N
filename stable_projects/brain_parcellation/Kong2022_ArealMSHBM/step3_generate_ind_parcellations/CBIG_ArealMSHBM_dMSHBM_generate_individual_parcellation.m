function [lh_labels, rh_labels] = CBIG_ArealMSHBM_dMSHBM_generate_individual_parcellation(project_dir, ...
    mesh, num_sess, num_clusters, subid, w, c, subject_set)
...
%
% This script will estimate the distributed areal-level individual parcellation 
...
%
% Example:
% [lh_labels, rh_labels] = CBIG_ArealMSHBM_dMSHBM_generate_individual_parcellation(project_dir,'fs_LR_32k','2', ...
% '400','1','30','30','test_set')
%
...
%% read group priors
group_prior_file = fullfile(project_dir, 'priors', 'dMSHBM', 'Params_Final.mat');   
...
out_dir = fullfile(project_dir,'ind_parcellation_dMSHBM', subject_set, ...
          [num2str(setting_params.num_session) '_sess']);
